...
namespace DienThoaiShop.Areas.Admin.Controllers
{
    ...
    public class BinhLuanBaiVietController : Controller
    {
        ...
        public BinhLuanBaiVietController(DTShopDbContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        {
            var dTShopDbContext = _context.BinhLuanBaiViet.Include(b => b.BaiViet).Include(b => b.NguoiDung).OrderByDescending(r => r.NgayDang);
